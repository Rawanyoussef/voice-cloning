...
def main():
    ...
    text = """ مساء الخير، إزيّك؟
خلّيني أقولك إن الكلام اللي سامعه دلوقتي معمول بهدوء وبنبرة طبيعية جدًا.
مفيش تمثيل ولا ضغط على الصوت، كله كلام عادي زي أي مكالمة يومية.
الهدف بس إننا نسمع النبرة صح ونطمن إن الصوت واضح ومريح للأذن.
لو حاسس إن الصوت تمام، يبقى نكمّل بعدها بسهولة.
تمام؟ شكراً ليك.
"""
