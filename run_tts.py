...
def main():
    ...
    # Text to be converted to speech (عامية مصرية)
    text = """
مَساءُ الخَير، إزَيِّك؟
...
"""
    ...
    print("\n🎵 Generating speech...")
    print("⚙️  Processing text using reference voice...")
    ...
    try:
        ...
        if output_file.exists():
            ...
            print("📂 File saved at: output/generated_voice.wav")
