...
def main():
    ...
    text = """ إزيّك؟
أنا بتكلم دلوقتي بهدوء كده، طبيعي خالص، من غير تمثيل ولا أي مبالغة.
الصوت ده مجرد تجربة علشان نسمع النبرة صح ونشوف الكلام طالع إزاي.
خد نفس كده واسمعني على راحتك…
لو الصوت واضح، يبقى تمام أوي، ونكمّل بعد كده واحدة واحدة.
ههه… يلا تمام.
"""
